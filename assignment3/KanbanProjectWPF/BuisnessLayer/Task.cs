...
namespace Milstone2
{
    public class Task
    {
        ...
        public Task(string title, string description, string dueDate,string creationDate, string author, int taskCounter)
        {
            this.TITLE = title;
            this.DESCRIPTION = description;
            this.STATUS = BackLog;
        ...
        public void save()
        {
            DataLayerTask.save(this.TITLE, this.DESCRIPTION, this.STATUS, this.DUEDATE.ToShortDateString(),this.CREATIONDATE.ToShortDateString(), this.AUTHOR, this.taskUID);
